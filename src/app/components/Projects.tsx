...
const Projects = () => {
    return (
        <ul className="flex flex-col py-10 text-[#ADB7BE] mx-2 text-xs lg:text-xl">
            ...
            <li className="group my-8 relative grid grid-cols-8 gap-8 transition-all sm:items-center sm:gap-8 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                <div className="absolute -inset-x-0 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                <Image src="/images/switch.gif" width={200} height={200}  alt="me" unoptimized className='z-10 col-span-4  lg:col-span-2 rounded border-2 object-center border-slate-200/10 transition group-hover:border-slate-200/30 lg:mx-4'/>
                <div className='z-10 lg:col-span-6 col-span-4 lg:my-2 my-8'>
